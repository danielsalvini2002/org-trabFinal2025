...
MSG_JOGAR: .asciz "Deseja jogar? (1 - Sim, 2 - Nao): " # Define string para perguntar se quer jogar
...
MSG_OPCOES: .asciz "O que voce deseja fazer? (1 - Hit, 2 - Stand): " # Define string para opções do jogador
...
MSG_VITORIA_JOGADOR: .asciz "Voce venceu!\n" # Define string para vitória do jogador
MSG_VITORIA_DEALER: .asciz "O dealer venceu!\n" # Define string para vitória do dealer
